...
public class ClientApp {
	public static void main(String[] args) {
		...
		// Car :: 9 param constructor...
		// Car [regNo=KA4567, engineNo=12345, type=Hatchback, model=Swift,
		...
		// Car :: 9 param constructor...
		// Car [regNo=JH1234, engineNo=6789, type=Hatchback, model=Swift, company=Maruti
